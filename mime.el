...
;; Version: $Header: mime.el,v 1.62 94/04/16 20:28:22 umerin Locked $
...
;; Mule (a multilingual extension to Emacs 18) has a capability of
;; handling multilingual text in limited ISO-2022 manner that is based
;; on early experiences in Japanese Internet community and resulted in
;; RFC1468 (ISO-2022-JP charset for MIME).  In order to enable
;; multilingual capability in single text message in MIME, charset of
;; multilingual text written in Mule is declared as `ISO-2022-JP-2'
;; [RFC 1554] and such messages are encoded in Mule style.  Mule is
;; required for reading the messages of `ISO-2022-JP-2' charset.
...
;; $Date: 94/04/16 20:28:22 $|$Revision: 1.62 $|~/misc/mime.el.Z|
...
Mule:		US-ASCII, ISO-8859-* (except for ISO-8859-6),
		ISO-2022-JP, and ISO-2022-JP-2 are available.

ISO-2022-JP-2 charset used in Mule is expected to be used to represent
multilingual text in intermixed manner.  Any languages that has no
registered charset are also represented as ISO-2022-JP-2 in Mule.
...
US-ASCII, ISO-8859-* (except for ISO-8859-6), ISO-2022-JP and
ISO-2022-JP-2 are supported on Mule."
...
US-ASCII, ISO-8859-* (except for ISO-8859-6), ISO-2022-JP and
ISO-2022-JP-2 are supported on Mule.  Charset ISO-2022-JP-2 is used
for multilingual text."
  (let ((lclist (find-charset-region begin end)))
    (cond ((null lclist)
	   '("US-ASCII" . nil))		;Default charset of MIME.
	  ((> (length lclist) 1)	;Requre multilingual capability
	   '("ISO-2022-JP-2" . nil))
	  ((memq lc-ltn1 lclist)
	   '("ISO-8859-1" . "quoted-printable"))
	  ((memq lc-ltn2 lclist)
...
STRING.  US-ASCII, ISO-8859-* (except for ISO-8859-6), ISO-2022-JP and
ISO-2022-JP-2 are supported on Mule.  Charset ISO-2022-JP-2 is used
for multilingual text."
  (let* ((charset (car method))
	 (encoding (cdr method))
